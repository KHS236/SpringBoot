...
public class kakaoLoginController {
    ...
    private String REDIRECT_URI="http://localhost:5555/kakao/getCode";
    private String LOGOUT_REDIRECT_URI="http://localhost:5555/kakao";
...
//
    ...
    public void logout1(){
        ...
        //연결 해제 (동의 철회 , 액세스 토큰 만료 , 리프래시 토큰 만료)
    @GetMapping("/logout2")
    @ResponseBody
    public void logout2(){
