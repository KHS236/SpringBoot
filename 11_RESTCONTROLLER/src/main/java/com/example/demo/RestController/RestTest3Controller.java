...
@Slf4j
//@CrossOrigin(origins = {도메인}) //백엔드 CORS에러 처리용 어노테이션
@CrossOrigin(origins = {"http://192.168.5.50:5500","http://localhost:5500"},
        originPatterns="*",
        allowCredentials = "false", //쿠키 제어
        allowedHeaders = {"Content-Type","apllication/json"}, //요청헤더 제한
