...
//        list.forEach(System.out::println);
    ...
    @Test
    public void t13() {
        Map<String,Object> param = new HashMap(); //일단 비어있는 param 만들어서 넣었음
        param.put("type","text");
        param.put("keyword","5"); //5가 포함된
    ...
    public void t14() {
        Map<String,Object> param = new HashMap(); //일단 비어있는 param 만들어서 넣었음
        param.put("field","1"); // 필드 하나를 본다
        param.put("type","writer"); //type이 text , writer
        param.put("keyword","작성자"); //5 || "작성자"가 포함된
    ...
    public void t15() {
        Map<String,Object> param = new HashMap(); //일단 비어있는 param 만들어서 넣었음
        param.put("field","3");
        param.put("type",Arrays.asList("text","writer")); //type을 list형으로 전달
        param.put("keyword","5"); //필드 3개중 type이 text,writer인 컬럼에 키워드가 5가 포함된
